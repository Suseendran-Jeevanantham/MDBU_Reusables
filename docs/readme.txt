readme.txt file  for CustomProject: (Project name CustomProject)
...
You can alternatively start the application by running the win32_start.bat batch file that is located
 in the application folder.  This is typically installed in the guicomposer folder that is in your Users folder. e.g:
        c:\Users\<myUserName>\guicomposer\runtime\gcruntime.v3\CustomProject\launcher.exe
...
To install all prerequisites for your application:
  ...
  * open a terminal window
  * cd into the the CustomProject folder that is in the guicomposer runtime folder path you
specified when installing your application.
...
To run your application, cd into the CustomProject folder and enter the following command:
